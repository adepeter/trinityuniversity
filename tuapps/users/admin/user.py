...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('email', 'id', 'username', 'get_full_name', 'gender', 'is_admin', 'is_superuser')
    list_filter = ('is_admin', 'is_superuser', 'gender')
    ...
    fieldsets = [
        ...
        (_('Personal info'), {
            'fields': ('fullname', 'gender', 'country', 'about')
        }),
        (_('Photos'), {
            'fields': (('preview_avatar', 'preview_cover'), 'avatar',)
        }),
        (_('Permissions'), {
    ...
    @admin.display(description=_('Full Name'), empty_value=_('Not set yet'))
